      ...
      <div className="py-[100px] ">
        <div className="sm:container mx-auto px-[10px] overflow-x-auto ">
          ...
          <div className="overflow-x-auto">
            <table className="border-[1px] w-[800px] lg:w-full font-inter ">
              <thead>
              ...
              <tbody className="text-[#212529]">
                <tr className="border-[1px]">
                  <td className="border-r-[1px] text-center px-[10px] py-[20px] ">
                  ...
                  <td className="border-r-[1px] text-centerpx-[10px] py-[20px]">
                    <a
                      href="#"
