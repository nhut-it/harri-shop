...
const HomeBanner = () => {
  return (
    <div className="container mx-auto">
      <div className="p-[60px] md:p-[100px] h-[460px] bg-[#F0F2ED] bg-home-banner   bg-[20%] bg-cover  md:bg-[18%] md:bg-cover lg:bg-[50%]">
        <div className="max-w-[400px]">
          ...
          <a
            href=""
            className="text-[44px] font-roboto text-title font-bold leading-[1] mb-[27px] inline-block hover:text-primary transition duration-500"
          >
